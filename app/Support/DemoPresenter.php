    ...
    public static function operation(DemoOperation $operation): array
    {
        return [
            ...
            'race' => $operation->speedwayRace ? [
                ...
                'winner_position' => $operation->speedwayRace->winner_position,
                'winner_color' => $operation->speedwayRace->winner_color,
                'result_forecast_order' => $operation->speedwayRace->result_forecast_order,
                'result_tricast_order' => $operation->speedwayRace->result_tricast_order,
                'underdog_position' => $operation->speedwayRace->underdog_position,
            ] : null,
